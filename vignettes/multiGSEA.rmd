...
Comptox Dashboard IDs (DTXCID, DTXSID), CAS-numbers, Pubchem IDs (CID, SID),
HMDB, KEGG, and ChEBI identifiers is accomplished through a comprehensive
mapping table with more than 1 million compounds that is part of the package.
...
R_packages <- c("knitr", "RColorBrewer", "tidyverse",
                "Rcpp", "metap")
...
kable( df %>% arrange( combined_padj) %>% dplyr::select( c( transcriptome_padj, proteome_padj, metabolome_padj, combined_padj))
