...
getMultiOmicsFeatures <- function( dbs = c("all"), layer = c("all"), 
    ...
    if( "transcriptome" %in% layer){
        features$transcriptome <- getMappedFeatures( pathways = pathways,
                                                     organism = organism,
    ...
    if( "proteome" %in% layer){
        ...
        if( "transcriptome" %in% layer && returnProteome == returnTranscriptome){
            ...
            features$proteome <- getMappedFeatures( pathways = pathways,
                                                    organism = organism,
    ...
    if( "metabolome" %in% layer){
        features$metabolome <- getMappedFeatures( pathways = pathways, 
                                                  organism = organism, 
